...
# different result from large-v3-turbo, which dropped BP3309 and misread 5000K
# as 4000K -- quantisation costs far less than distillation here. A third of
# the size means less memory bandwidth per token, which is the actual
# bottleneck on Apple Silicon.
MODEL = BASE / "models/ggml-large-v3-q5_0.bin"
WORK = BASE / "work"
OUT = BASE / "out"
LOGS = BASE / "logs"
